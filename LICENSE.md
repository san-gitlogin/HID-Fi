...
Required Notice: Copyright (c) 2026 Santhosh — HID-Fi
<https://github.com/san-gitlogin/HID-Fi>
...
The license above covers **noncommercial use only**.

If you want to use this in or around a business — selling boards with it, putting
it in a product, using it as part of paid work or a paid service, or anything
with an anticipated commercial application — you need a separate commercial
license from the author.

Commercial terms are negotiable and are typically either a flat fee or a
revenue share, depending on what you are building.

**Contact:** `san.phplogin@gmail.com`

Asking is not a formality and the answer is usually yes. Please just ask first.
